...
template class ThreadSafeQueue<struct EncoderArguments>;
template class ThreadSafeQueue<struct GeneratorArguments>;
template class ThreadSafeQueue<struct KmerBin>;
